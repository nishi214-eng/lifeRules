    ...
    try {
        ...
        const response = await axios.post("https://api.openai.com/v1/chat/completions", {
            ...
            headers: {
                ...
                Authorization: `Bearer ${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}`,
            },
        });
